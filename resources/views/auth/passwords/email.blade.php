...
border-radius: 5px;
  ...
  <form method="POST" action="{{ route('password.email') }}">
      @csrf
        ...
        <input id="email" type="email" class="form-control @error('email') is-invalid @enderror fadeIn second" style="text-align: left"   placeholder="Email" name="email" value="{{ old('email') }}" required autocomplete="email" autofocus>
