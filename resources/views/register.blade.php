...
.select{
  ...
  <div class="wrapper fadeInDown" style="margin-top: 90px;">
    <div id="formContent" style="padding: 20px;">
      ...
      <!-- Login Form -->
      <form>
        <input type="text"  class="fadeIn second" name="name" placeholder="Name" style="text-align: left" required>
        <input type="text"  class="fadeIn second" name="number" placeholder="Number" style="text-align: left" required>
        <input type="text" id="login" class="fadeIn second" name="email" placeholder="Email" style="text-align: left" required>
        <select name="type" class="select">
            <option value="volvo">User</option>
            <option value="saab">Advisor</option>
          </select>
        <input type="text" id="password" class="fadeIn third" name="Password" placeholder="Password" style="text-align: left" required>
